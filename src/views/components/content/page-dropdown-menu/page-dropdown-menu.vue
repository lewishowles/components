<template>
	<component-page>
		...
		<template #introduction>
			<p><code>dropdown-menu</code> is an extension of a floating <code>summary-details</code>, providing a quick and easy way to create dropdown or action menus. From actions in tables to bulk item management, dropdown menus provide an easy, accessible way to de-clutter an interface, but should not be used where very common actions would be hidden and more difficult to access for the sake of cleanliness.</p>
