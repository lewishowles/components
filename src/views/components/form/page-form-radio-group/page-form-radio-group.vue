<template>
	<component-page>
		...
		<template #introduction>
			<p><code>form-radio-group</code> provides a convenient way to create a group of <code>radio</code> inputs.</p>
		...
		<component-props>
			<component-prop id="prop-options">
				...
				<p>The options to display as radio buttons can be provided in a number of formats for ease.</p>
			...
			<component-prop id="prop-inline">
				...
				<p>Whether to display options inline (horizontally). This is only recommended when there are two to three options. Any more than that, and vertical display is more clear for the user.</p>
				<p>Note that this only takes effect when the radio buttons are in a <em>container</em> that is at least 320px wide.</p>
			</component-prop>
		</component-props>
