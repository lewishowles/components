<template>
	<div class="prose prose-slate dark:prose-invert *:animate-fade-in *:delay">
		...
		<p>
			At the moment, components in the library are registered globally, so there is no need to
			manually import any of the components. To use the library, set it up in your main file, for
			example:
		</p>
		...
		<p>
			Since components are globally registered for now, you can simply use them directly anywhere in
