<template>
	<component-page>
		...
		<template #introduction>
			<p>
				<code>useFloatingPosition</code> positions a floating panel relative to a trigger element,
				flipping its placement and alignment when the panel would otherwise clip the edge of the
				viewport.
			</p>
			...
			<p>
				...
				<router-link v-bind="{ to: '/content/floating-details' }">
					<code>floating-details</code> </router-link
		...
		<component-parameters>
			...
			<component-parameter id="parameter-initial-placement">
				...
				<p>
					The preferred placement of the panel: <code>"above"</code> or <code>"below"</code>. Flips
					to the opposite side if the preferred side would clip the viewport.
				</p>
			</component-parameter>
			...
			<component-parameter id="parameter-initial-align">
				...
				<p>
					The preferred alignment of the panel: <code>"start"</code> or <code>"end"</code>. Flips to
					the opposite side if the preferred side would clip the viewport.
				</p>
			</component-parameter>
		</component-parameters>
		...
		<component-returns>
			<component-return id="return-computed-placement">
				...
				<p>
					The resolved placement (<code>"above"</code> or <code>"below"</code>) after measuring.
				</p>
			</component-return>
			...
			<component-return id="return-computed-align">
				...
				<p>The resolved alignment (<code>"start"</code> or <code>"end"</code>) after measuring.</p>
			</component-return>
			...
			<component-return id="return-placement-classes">
				...
				<p>
					A gap utility class reflecting the resolved placement (<code>mb-3</code> when above,
					<code>mt-3</code> when below).
				</p>
			</component-return>
		</component-returns>
