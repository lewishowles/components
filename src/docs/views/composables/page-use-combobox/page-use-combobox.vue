	...
	<component-page>
		...
		<template #introduction>
			<p>
				...
				provides the groundwork for implementing a combobox interaction pattern, including ARIA
				attribute management and keyboard handling.
			</p>
		...
		<component-parameters>
			<component-parameter id="parameter-options">
				...
				<template #type>array | ref | getter</template>

				<p>
					The ordered list of option IDs the user can navigate, as a plain array, a ref, or a
					getter. Navigation follows this order, and the active option is cleared automatically when
					it leaves the list.
				</p>
			</component-parameter>
			...
			<component-parameter id="parameter-listbox-id">
				...
				<p>
					The ID used to link the input's
					<code>aria-controls</code>
					to the listbox's
					<code>id</code>
					. A unique ID is generated automatically if one is not provided.
				</p>
			</component-parameter>
		...
		<component-returns>
			...
			<component-return id="return-active-id">
				...
				<p>
					The ID of the currently highlighted option, or
					<code>null</code>
					when none is highlighted. Drives
		...
		<component-methods>
			...
			<component-method id="method-select-option">
				...
				<p>
					Select an individual option, which in turn calls
					<code>onSelect</code>
					and closes the popup. Selects the currently highlighted option when no ID is provided.
				</p>
			</component-method>
			...
			<component-method id="method-handle-keydown">
				...
				<p>
					...
					functionality: arrow keys open and navigate the list,
					<code>Enter</code>
					selects,
					<code>Escape</code>
					closes, and cursor keys return to text editing.
				</p>
			</component-method>
		</component-methods>
	</component-page>
