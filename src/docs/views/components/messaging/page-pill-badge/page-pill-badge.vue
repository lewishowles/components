<template>
	<component-page>
		<template #title>Pill badge</template>

		<template #introduction>
			<p>
				The
				<code>pill-badge</code>
				is great for showing statuses or changes in data.
			</p>
		</template>
		...
		<component-props>
			<component-prop id="prop-icon-start">
				...
				<p>An icon to display at the start of a badge.</p>
			...
			<component-prop id="prop-icon-end">
				...
				<p>An icon to display at the of a badge.</p>
			...
			<component-prop id="prop-colour">
				<template #name>colour</template>
				...
				<p>
					The colour of this badge, one of
					<code>grey</code>
					,
					<code>red</code>
					,
		...
		<component-slots>
			<component-slot id="slot-default">
				...
				<p>The default slot contains the text of the label.</p>
			</component-slot>
		</component-slots>

		<component-styling-hooks>
			<component-styling-hook id="hook-data-component">
				<template #attribute>data-component="pill-badge"</template>
