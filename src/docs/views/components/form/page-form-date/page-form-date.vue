<template>
	<component-page>
		...
		<template #introduction>
			<p>
				<code>form-date</code> is a date component that aims to remove any confusion when it comes
				to dates by providing three separate, labelled inputs.
			</p>
			<p>
				At this time, the component doesn't include a calendar component, which should only really
				be used when the user needs to select a date in the recent past or near future.
			</p>
			<p>
				<code>form-date</code> models its date as <code>{ day, month, year }</code>, allowing any
				further manipulation to be done easily.
			</p>
		</template>
		...
		<component-props>
			<component-prop id="prop-id">
				...
				<p>
					Any ID to use as a basis for this field. If an ID is not provided, one will be generated
					at random. IDs provided will be suffixed with <code>day</code>, <code>month</code> and
					<code>year</code> as appropriate to differentiate the fields.
				</p>
				<p>
			...
			<component-prop id="prop-day-placeholder">
				<template #name> dayPlaceholder </template>
			...
			<component-prop id="prop-month-placeholder">
				...
				<p>
					Any placeholder to show in the &quot;Month&quot; field. Do not use a placeholder for
					critical information. Always use the label and help text as priorities.
				</p>
			</component-prop>
			<component-prop id="prop-year-placeholder">
				<template #name> yearPlaceholder </template>
				...
				<p>
					Any placeholder to show in the &quot;Year&quot; field. Do not use a placeholder for
					critical information. Always use the label and help text as priorities.
				</p>
			</component-prop>
		</component-props>
		...
		<component-slots>
			...
			<component-slot id="slot-introduction">
				...
				<p>
					Any additional text to introduce this field, which appears between the label and the
					inputs.
				</p>
			</component-slot>
			<component-slot id="slot-day-label">
				<template #name> day-label </template>

				<p>The label for the "Day" field.</p>
			</component-slot>
			<component-slot id="slot-month-label">
				<template #name> month-label </template>

				<p>The label for the "Month" field.</p>
			</component-slot>
			<component-slot id="slot-year-label">
				<template #name> year-label </template>
		...
		<component-methods>
			<component-method id="method-to-string">
				...
				<p>
					...
					<link-tag
						href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/PlainDate#rfc_9557_format"
						:external="true"
					>
						RFC 9557 format </link-tag
					>.
				</p>
			</component-method>
			<component-method id="method-set-date-from-iso-string">
				...
				<p>
					Set the current <code>day</code>, <code>month</code>, and <code>year</code>, as parsed
					from an
					<a
						href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Temporal/PlainDate#rfc_9557_format"
						>RFC 9557 format</a
		...
		<component-styling-hooks>
			<component-styling-hook id="hook-data-component">
				<template #attribute>data-component="form-date"</template>
