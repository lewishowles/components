<template>
	<component-page>
		...
		<template #introduction>
			<p>
				<code>form-date</code>
				is a date component that aims to remove any confusion when it comes to dates by providing
				three separate, labelled inputs.
			</p>
			<p>
			...
			<p>
				...
				, allowing any further manipulation to be done easily.
			</p>
		</template>
		...
		<component-props>
			<component-prop id="prop-id">
				...
				<p>
					...
					at random. IDs provided will be suffixed with
					<code>day</code>
					,
					<code>month</code>
					and
					<code>year</code>
					as appropriate to differentiate the fields.
				</p>
				<p>
		...
		<component-events>
			<component-event id="event-v-model">
				...
				<p>
					The current value of the field will be available via
					<code>v-model</code>
					.
				</p>
			</component-event>
