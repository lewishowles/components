	...
	<component-page>
		...
		<template #introduction>
			...
			<p>
				...
				using cell templates, the latter is recommended. If the data is passed to the table in a
				more raw form, it may be easier for a table to be sortable out of the box (for example, with
		...
		<component-props>
			<component-prop id="prop-data">
				...
				<p>
					...
					single row, containing a key for each column of the table, which itself contains the
					content for that column.
				</p>
			</component-prop>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								Whether this column is hidden, allowing hidden columns to be more explicitly defined
								where helpful.
							</td>
						</tr>
						<tr>
							...
							<td>
								Whether this column is included in searches. If false, search will ignore this
								column entirely.
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								The alignment of the column. Anything but &quot;right&quot; will be treated as
								&quot;left&quot;.
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><code>false</code></td>
							<td>
								Whether to apply tabular number formatting to cells in this column. Useful for
								numeric columns to ensure digits align vertically.
							</td>
						</tr>
					</tbody>
				</table>
			...
			<component-prop id="prop-enable-search">
				...
				<p>
					...
					search the text for each cell case-insensitively, and hide any rows where none of the
					cells match.
				</p>
			</component-prop>
		...
		<component-slots>
			...
			<component-slot id="slot-caption">
				...
				<p>
					...
					container, this caption is also used to label the scrollable region for assistive
					technology.
				</p>
			</component-slot>
			...
			<component-slot id="slot-sorted-hint">
				...
				<p>
					...
					table is currently sorted by. Only rendered when a column is sorted.
				</p>
			...
			<component-slot id="slot-columnName_heading">
				...
				<p>
					Provides the ability to override the label for a particular column, by its key from the
					original data. Provided to the slot are is the key for that column.
				</p>
			...
			<component-slot id="slot-columnName">
				...
				<p>
					...
					original data. Provided to the slot are the content of the cell itself, as well as the
					rest of its row, allowing cells to be combined where necessary.
				</p>
		...
		<component-methods>
			<component-method id="method-set-search-query">
				...
				<p>
					Set the table's current search query, overriding any current search. This could be used in
					conjunction with a cell template to allow the user to find all similar rows, for example.
				</p>
