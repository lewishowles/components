	...
	<component-page>
		...
		<template #introduction>
			...
			<p>
				...
				overwhelming number of options into distinct groups. A tab should clearly label its
				contents, meaning the user has to do the minimum thinking to determine where to look for the
				item they need.
			</p>
			<p>
			...
			<p>
				Tabs shouldn’t be represented by icons only, which would increase the user’s mental load
				unnecessarily.
			</p>
			<p>
				Finally, if at all possible, avoiding a large number of tabs is preferable, as it suggests
				that there is too much happening on a single screen.
			</p>
		...
		<component-props>
			...
			<component-prop id="prop-remember-selection">
				...
				<p>
					...
					be reinstated on load. Note that when using this feature, tabs must be given custom IDs,
					as opposed to the default IDs, which are randomly generated.
				</p>
			</component-prop>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td><code>string</code></td>
							<td>
								A unique ID for this tab's panel (or content), used to link a tab and its panel
								together.
							</td>
						</tr>
						<tr>
