<template>
	<component-page>
		...
		<template #introduction>
			<p>
				Provided an array,
				<code>searchable-list</code>
				provides a search box to filter those items. The list of results is provided to the default
				slot, meaning they can be displayed however best suits the implementation.
			</p>
			...
			<p>
				...
				<code>exclude</code>
				prop. Alternatively, only certain properties can be included via the
				<code>include</code>
				prop. If the displayed item and searchable content should differ, use the
				<code>search</code>
				prop to map each item to the value that should be searched.
			</p>
			<p>
				The current search query will be available via
				<code>v-model</code>
				.
			</p>
		</template>
