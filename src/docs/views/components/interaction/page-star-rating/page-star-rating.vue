	...
	<component-page>
		...
		<component-slots>
			...
			<component-slot id="slot-option-label">
				...
				<p>
					The label for each selectable option. Receives
					<code>{ value }</code>
					as a slot prop. Defaults to unit-aware English ("1 star", "2 stars", "1 heart", etc.).
				</p>
			</component-slot>
			...
			<component-slot id="slot-read-only-label">
				...
				<p>
					...
					display. Receives
					<code>{ value }</code>
					as a slot prop (the current model value). Defaults to "Star rating" when no value is set,
					or "Rating: N of max stars" when one is.
				</p>
			</component-slot>
