...
const detailsClasses = "animate-fade-in-down animate-fast mt-2 min-w-xs rounded-lg border border-grey-200 bg-white py-2 shadow dark:border-white/20 dark:bg-grey-800";
