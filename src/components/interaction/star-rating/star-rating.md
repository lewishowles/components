...
`star-rating` offers two optional, mutually inclusive options. Users can either select a rating, or view the current aggregate rating. `star-rating` is an extension of `form-field[type="radio"]` (and thus `form-radio-group`).
