				...
				expect(options.value).toEqual([
					{
						...
						label: "one",
						value: 1,
						originalOption: { label: "one", value: 1 },
						first: true,
						last: false,
					},
					{
						...
						label: "two",
						value: 2,
						originalOption: { label: "two", value: 2 },
						first: false,
						last: false,
					},
					{
						...
						label: "three",
						value: 3,
						originalOption: { label: "three", value: 3 },
						first: false,
						last: true,
					},
				]);
				...
				expect(options.value).toEqual([
					{
						...
						label: "Tennis",
						value: 1,
						originalOption: { sport: "Tennis", score: 1 },
						first: true,
						last: false,
					},
					{
						...
						label: "Curling",
						value: 2,
						originalOption: { sport: "Curling", score: 2 },
						first: false,
						last: false,
					},
					{
						...
						label: "Ice Hockey",
						value: 3,
						originalOption: { sport: "Ice Hockey", score: 3 },
						first: false,
						last: true,
					},
				]);
				...
				expect(options.value).toEqual([
					{
						...
						originalOption: { sport: "Tennis", score: 1, summary: "A racket sport." },
						first: true,
						last: true,
					},
				]);
