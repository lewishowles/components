<template>
	<dialog ref="dialog" class="fixed start-1/2 top-1/2 -translate-1/2 w-full max-w-2xl rounded-md border border-grey-300 p-12 text-current shadow-2xl dark:border-white/20" data-test="modal-dialog">
		...
		<h2 v-if="haveTitle" class="mb-6 text-2xl font-bold text-grey-950">
			<slot name="title" />
		</h2>
