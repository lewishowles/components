import{_ as t,a as r,b as o,h as p,d as l,w as i,n as s,g as a,e as m,o as u}from"./index-EwpuvNAy.js";const d={},f={class:"prose prose-slate dark:prose-invert *:animate-fade-in *:delay"};function b(y,e){const n=m("router-link");return u(),r("div",f,[e[2]||(e[2]=o("h1",null,"Getting started",-1)),e[3]||(e[3]=o("p",null,"At the moment, components in the library are registered globally, so there is no need to manually import any of the components. To use the library, set it up in your main file, for example:",-1)),e[4]||(e[4]=o("pre",null,`import { createApp } from "vue";
